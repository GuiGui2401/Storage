...
hourey_image0 = face_recognition.load_image_file("hourey/Hourey0.jpg")
hourey_face_encoding0 = face_recognition.face_encodings(hourey_image0)[0]

hourey_image1 = face_recognition.load_image_file("hourey/Hourey1.jpg")
hourey_face_encoding1 = face_recognition.face_encodings(hourey_image1)[0]
...
known_face_encodings = [
    ...
    hourey_face_encoding0,
    hourey_face_encoding1,
