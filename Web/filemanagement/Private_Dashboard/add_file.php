...
<head>
  ...
  <title>SUP'PTIC End-of-studies Memory Manager</title>
  <!-- Font Awesome -->
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <a class="logo-wrapper waves-effect">
        ...
        <a href="dashboard.php" class="list-group-item list-group-item-action waves-effect">
          <i class="fas fa-chart-pie mr-3"></i>Plagiarism
        </a>
        ...
        <a href="add_document.php" class="list-group-item active waves-effect">
        ...
        <form action="fileprocess.php" method="post" enctype="multipart/form-data" >
          <div class="col-md-11">
              <div class=""><br>
                ...
                <input type="text" name="auteurs" id="auteurs" required><br><br>

                <label for="annee">Année:</label><br>
                <select name="annee" id="annee" required>
                    <?php
                    // Générer les options de la liste déroulante pour les années
                    $currentYear = date("Y");
                ...
                <label for="encadreur">Encadreur:</label><br>
                <input type="text" name="encadreur" id="encadreur" required><br><br>
                
                <label for="encadreur">Niveau:</label>
                <input type="radio" name="niveau" id="licence" value="LicenceIII" checked>Licence III&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" name="niveau" id="Master" value="MasterII">Master II<br><br>

                <label for="encadreur">Thème:</label><br>
