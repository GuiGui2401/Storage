...
Total Patients :<?php echo htmlentities($num_rows);  
									...
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-users fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">Manage Pharmacy</h2>
										
											<p class="cl-effect-1">
												<a href="manage-doctors.php">
												<?php $result1 = mysqli_query($con,"SELECT * FROM pharmacien ");
$num_rows1 = mysqli_num_rows($result1);
{
?>
											Total Pharmacy :<?php echo htmlentities($num_rows1);  } ?>		
												</a>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-users fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">Manage Laborantin</h2>
										
											<p class="cl-effect-1">
												<a href="manage-doctors.php">
												<?php $result1 = mysqli_query($con,"SELECT * FROM laborantin ");
$num_rows1 = mysqli_num_rows($result1);
{
?>
											Total Laborantin :<?php echo htmlentities($num_rows1);  } ?>		
												</a>
