							...
							<li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Pharmacy </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
									<li>
										<a href="add-pharma.php">
											<span class="title"> Add Pharmacy</span>
										</a>
									</li>
									<li>
										<a href="Manage-pharma.php">
											<span class="title"> Manage Pharmacy </span>
										</a>
									</li>
							...
							<li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Laborantin </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
									<li>
										<a href="add-labo.php">
											<span class="title"> Add Laborantin</span>
										</a>
									</li>
									<li>
										<a href="Manage-labo.php">
											<span class="title"> Manage Laborantin </span>
										</a>
									</li>
...
<li>
				...
				<li>
						...
						<li>
							...
							<li>
								<a href="pharma-logs.php">
									<div class="item-content">
										<div class="item-media">
											<i class="ti-list"></i>
										</div>
										<div class="item-inner">
											<span class="title"> Pharmacy Session Logs </span>
										</div>
									</div>
								</a>
							</li>	
							...
							<li>
								<a href="labo-logs.php">
									<div class="item-content">
										<div class="item-media">
											<i class="ti-list"></i>
										</div>
										<div class="item-inner">
											<span class="title"> Laborantin Session Logs </span>
										</div>
									</div>
								</a>
							</li>	
