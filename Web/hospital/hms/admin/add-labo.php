...
$sql=mysqli_query($con,"insert into laborantin(doctorName,address,docFees,contactno,docEmail,password) values('$docname','$docaddress','$docfees','$doccontactno','$docemail','$password')");
if($sql)
{
echo "<script>alert('Laborantin info added Successfully');</script>";
echo "<script>window.location.href ='manage-labo.php'</script>";
...
<html lang="en">
	<head>
		<title>Admin | Add Laborantin</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Add Laborantin</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Add Laborantin</h5>
												</div>
